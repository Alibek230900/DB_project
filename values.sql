...
AS
BEGIN
  insert into Employees values('e'||emp_seq.nextval, 'Gulsezim', 'Almaty', '4082345679', 8);    -- 1 SUPERVISOR
  insert into Employees values('e'||emp_seq.nextval, 'Jomart', 'Talgar', '4082225678', 4); -- 2 DRIVER
  insert into Employees values('e'||emp_seq.nextval, 'Tauekel', 'Vodnik', '4088458323', 4.5); -- 3 DRIVER
  insert into Employees values('e'||emp_seq.nextval, 'Shaken', 'Baiserke', '4086341212', 5);  -- 4 DRIVER
  
  insert into Employees values('e'||emp_seq.nextval, 'Zhuldyz', 'Avat', '4158948003', 8); -- 5 SUPERVISOR
  insert into Employees values('e'||emp_seq.nextval, 'Asylbek', 'Qargaly', '4087896478', 6.5); -- 6 DRIVER
  
  insert into Employees values('e'||emp_seq.nextval, 'Laura', 'Qaskelen' , '5104328006', 8); -- 7 SUPERVISOR
  insert into Employees values('e'||emp_seq.nextval, 'Eskendir', 'Irgeli' , '5104328006', 5); -- 8 DRIVER
  
  insert into Employees values('e'||emp_seq.nextval, 'Dariya', 'Sayali', '4083345432', 8); -- 9 SUPERVISOR 
  insert into Employees values('e'||emp_seq.nextval, 'Quat', 'Chapaev', '4082553399', 4.5); -- 10 DRIVER 
  
  insert into Employees values('e'||emp_seq.nextval, 'Togzhan', 'Samal', '4085653432', 8); -- 11 SUPERVISOR
  insert into Employees values('e'||emp_seq.nextval, 'Daniyar', 'Koktobe', '6152553389', 4.5); -- 12 DRIVER 
  

  insert into Supervisors values ('e1', 85000,'e1admin'); -- Au
  insert into Supervisors values ('e5', 80000,'e5admin'); -- Bo
  insert into Supervisors values ('e7', 80000,'e7admin'); -- Al
  insert into Supervisors values ('e9', 80000,'e9admin'); -- Me
  insert into Supervisors values ('e11', 80000,'e11admin'); -- Al
...
AS
BEGIN
  insert into Restaurants values ('r'||rest_seq.nextval, 'Lagman',1, 'Lanzhou', '4082444100', 'Aby Ave 95', 'Al'); -- 1
  insert into Restaurants values ('r'||rest_seq.nextval, 'Comyan', 1,'Lanzhou', '4082985335', '140 E San Carlos St 95112', 'San Jose'); -- 2
  insert into Restaurants values ('r'||rest_seq.nextval, 'Kimchi', 1,'Mindon', '4089938230', '131 W Santa Clara St 95113', 'San Jose'); -- 3
  insert into Restaurants values ('r'||rest_seq.nextval, 'Philadephia', 1,'Samurai, '4085679144', '1505 Space Park Dr 95054', 'Santa Clara'); -- 4
  insert into Restaurants values ('r'||rest_seq.nextval, 'Margarita', 1,'Papa Jones', '4082410000', '700 Bellomy St 95050', 'Santa Clara'); -- 5
  insert into Restaurants values ('r'||rest_seq.nextval, 'Plov', 1,'Maxplov', '5102261588', '6997 Warm Springs Blvd 94539', 'Fremont'); -- 6
  insert into Restaurants values ('r'||rest_seq.nextval, 'Soup', 1,'Marmaris', '5107951100', '5355 Mowry Ave 94538', 'Fremont'); -- 7
  insert into Restaurants values ('r'||rest_seq.nextval, 'Manta', 1,'Qaganat', '4152558828', '460 Castro St 95114', 'San Francisco'); -- 8
  insert into Restaurants values ('r'||rest_seq.nextval, 'Ramen', 1,'BAO', '4158142920', '710 Florida St 94110', 'San Francisco'); -- 9
  insert into Restaurants values ('r'||rest_seq.nextval, 'Taiski', 'Shipudim', 1,'TOO', '6507526492', '261 University Ave 94301', 'Palo Alto');--10
  insert into Restaurants values ('r'||rest_seq.nextval, 'Borsh', 1,'Vostochnyi', '6503258500', '560 University Ave', 'Palo Alto');
END;
/
show errors; 
